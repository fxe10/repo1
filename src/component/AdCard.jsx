    ...
    render() {
        return (
            <div style={{position:'relative', float:'left',marginRight:'20px',marginBottom:'20px', width:'340px',height:'160px',border:'1px solid #ccc'}}>
                ...
                <div style={{position:'absolute' ,right:'0',bottom:'0', width:'56px',height:'20px',lineHeight:'20px', backgroundColor:'#3ba8f0',color:'#ffffff',fontSize:'12px',textAlign:'center'}}>行政班</div>
            </div>
        )
    }
}
